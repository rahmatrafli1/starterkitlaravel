            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-sm text-gray-500">Server maintenance scheduled</p>
                                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        ...
                        <div class="space-y-3">
                            <button
                                class="w-full flex items-center justify-between p-3 text-left bg-blue-50 hover:bg-blue-100 rounded-lg transition duration-150 ease-in-out">
                                <div class="flex items-center">
                            ...
                            <button
                                class="w-full flex items-center justify-between p-3 text-left bg-green-50 hover:bg-green-100 rounded-lg transition duration-150 ease-in-out">
                                <div class="flex items-center">
                            ...
                            <button
                                class="w-full flex items-center justify-between p-3 text-left bg-purple-50 hover:bg-purple-100 rounded-lg transition duration-150 ease-in-out">
                                <div class="flex items-center">
                                    <svg class="h-5 w-5 text-purple-600 mr-3" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl shadow-sm p-6 text-white">
                        ...
                        <p class="text-blue-100 text-sm mb-4">Manage your account settings and preferences.</p>
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit"
                                class="w-full bg-white/20 hover:bg-white/30 text-white font-medium py-2 px-4 rounded-lg transition duration-150 ease-in-out">
                                Sign Out
                            </button>
                        </form>
                    </div>
